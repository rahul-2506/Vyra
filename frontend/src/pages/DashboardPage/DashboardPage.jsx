    ...
    <motion.div {...pageTransition} className="pb-8 space-y-8">
      ...
      >
         ...
         <button 
           ...
           className="relative z-10 mt-6 bg-gradient-to-r from-farm-yellow to-farm-wheat hover:brightness-110 text-farm-soil font-extrabold text-xs tracking-wider px-8 py-4 rounded-xl flex items-center gap-2.5 shadow-lg border border-white/20 active:scale-95 transition-all hover:scale-105"
         >
